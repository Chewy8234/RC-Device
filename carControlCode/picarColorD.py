...
#initilize the camera and connect setting for the car
def initcam():
    Vilib.camera_start(True)
    Vilib.color_detect_switch(True)

    #COlor detection option beside red : (orange, yellow, green, blue, purple)
    Vilib.detect_color_name('red')

    #the “MakerStarsHall” and “sunfounder” need to change into users WLAN
